Public Class FormMenu
    ...
    Private Sub EnviarDadosEspectraisToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles EnviarDadosEspectraisToolStripMenuItem.Click
        Form3.Show()
    End Sub

    Private Sub CópiaDeSegurançaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles CópiaDeSegurançaToolStripMenuItem.Click
        Form4.Show()
    End Sub
End Class
